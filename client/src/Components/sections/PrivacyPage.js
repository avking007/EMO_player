    ...
    <Container maxWidth="sm" style={{ color: '#fff' }}>
      ...
      <section>
        <Typography gutterBottom={true} variant="subtitle1">
          Our Team built the EMOLight app as an Open Source app. This SERVICE is
          provided by us at no cost and is intended for use as is.
          <br />
        ...
        <Typography gutterBottom={true}>
          We want to inform you that whenever you use my Service, you never have
        ...
        <Typography gutterBottom={true}>
          We never employ any third-party companies and individuals except
